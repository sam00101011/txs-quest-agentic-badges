...
library AgenticPOAPMetadata {
    bytes16 private constant HEX_DIGITS = "0123456789abcdef";

    struct TokenMetadataInput {
        uint256 tokenId;
    ...
    function buildJson(
        TokenMetadataInput memory input,
        ...
        return string(
            abi.encodePacked(
                ...
                '","assets":[{"uri":"',
                asset.videoUri,
                '","mime_type":"video/mp4"}],"properties":{"token_id":"',
                _uintToString(input.tokenId),
                '","definition_id":"',
